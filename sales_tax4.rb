...
order1 = Order.new
binding.pry 
item1 = Item.new(1,"book",12.49,false, order1.object_id)
item2 = Item.new(1,"music CD",14.99,false, order1.object_id)
item3 = Item.new(1,"chocolate bar",0.85,false, order1.object_id)
item4 = Item.new(1,"chocolate bar",0.85,false, order1.object_id)

item3 = Item.new(1,"chocolate bar",0.85,false, 1111)
item4 = Item.new(1,"chocolate bar",0.85,false, 2222)
